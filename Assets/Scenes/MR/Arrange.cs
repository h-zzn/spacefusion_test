...
public class Arrange : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 moveForCharacter = Vector3.zero;
        ...
        for (int housesCount = 0; housesCount < houses.Count; housesCount++)
        {
            ...
            if (housesCount == chooseHouseNum)
            {
                ...
                if (housesCount == 0)
                {
                    ...
                    moveForCharacter = new Vector3(dataFromPython.house_0[0], 0, dataFromPython.house_0[1]);
                ...
                else if (housesCount == 1)
                {
                    ...
                    */
                    ...
                    moveForCharacter = new Vector3(dataFromPython.house_1[0], 0, dataFromPython.house_1[1]);

                    // AvatarCullingModule
                    if (avatarCullingModule != null)
                        avatarCullingModule.CreateSharedSpaceMesh(points);
                    //if (createSharedSpaceMesh != null)
                    //    createSharedSpaceMesh.Create(points);
                ...
                else
                {
                    ...
                    moveForCharacter = new Vector3(dataFromPython.house_2[0], 0, dataFromPython.house_2[1]);
                ...
                foreach (var item in augObjects)
                {
                    ...
                    if (int.Parse(parts[1]) != forObjAug)
                    {
                        // from which house
