...
public class StartMRVoronoi : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (initialCharactersIn == false && arrangeHousesObj.GetComponent<ArrangeMRHouses>().characterInitialized == true)
        {
        ...
        // sharedspacePoints
        SharedSpacePoints sharedspacePoints = arrangeHousesObj.GetComponent<ArrangeMRHouses>().sharedspacePoints;
        ...
        // update user pos 
        if (arrangeHousesObj.GetComponent<ArrangeMRHouses>().characterInitialized == true)
        {
