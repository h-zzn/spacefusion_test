...
public class ArrangeOnly : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int housesCount = 0; housesCount < houses.Count; housesCount++)
        {
            ...
            if (housesCount == chooseHouseNum)
            {
                ...
                string transfilename = Application.dataPath + "/Tayoptoutput/" + whichSet + "houseTrans.json";
                ...
                string groundtransfilename = Application.dataPath + "/Tayoptoutput/" + whichSet + "groundTrans_" + houses[housesCount].name.ToString() + ".json";
                ...
                */
                ...
                string filename = Application.dataPath + "/Tayoptoutput/" + whichSet + "mergedPolygon_" + housesCount.ToString() + ".json";

                //outPoints = script.alignedBaseline.GetAnchorOutpoints(allPolygonToDraw, filename, houses[housesCount].transform.position);
                ...
                // ------------------------------ Augment Object --------------------------------- //
                string byHouse = Application.dataPath + "/Tayoptoutput/" + whichSet + "objectBy_" + houses[housesCount].name + ".json";
